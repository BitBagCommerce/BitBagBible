...
10. We don't use either autowire nor autoconfigure Symfony options as it is a very "magic" way of defining services. We prefer to always manually define services and inject proper arguments into them to have better control of our Container.
11. If some of service definition is taged don't use FQCN as service id.
